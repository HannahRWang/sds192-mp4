...
ggplot(pop_seq2, aes(x = original_year, y = title)) +
  ...
  labs(color = 'Type of Movie', title = "Sequels and Remakes Produced by Decade", x = "Release Year of Original Movie", y = "Movie Title", caption = "(Based on data from IMDb) Each panel includes the top ten grossing movie of that decade.") +
